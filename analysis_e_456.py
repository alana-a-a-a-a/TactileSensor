...
# %%
clawdata_file = 'testing_2026_04_22_sample_e_456.txt'
...
def plot_one_case(Case, c, SampleName, endTOI=None):
    ...
    #ms[:5]
        ...
        df.to_csv(f'SampleE_Case{c}.csv')
...
# %%
plot_one_case(C1, 1, 'Sample E',2)
plot_one_case(C2, 2, 'Sample E',2)
plot_one_case(C3, 3, 'Sample E',2)
