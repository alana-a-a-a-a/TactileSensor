...
# %%
clawdata_file = 'testing_2026_04_22_sample_a_456.txt'
...
def plot_one_case(Case, c, SampleName, endTOI=None):
    ...
    #ms[:5]
        ...
        df.to_csv(f'SampleA_Case{c}.csv')
...
# %%
plot_one_case(C1, 1, 'Sample A',2)
plot_one_case(C2, 2, 'Sample A',2)
plot_one_case(C3, 3, 'Sample A',2)
